...
const urlroot = 'https://www.twingate.com/blog/';
const REGular = ".bQnGLA";
const FEAture = ".cfUVPA";
const blgBODY = ".gBlIog";
...
function parse_blog_url($, section){
    ...
    for (let i = 0; i < posts.length; i++) {
        let postTitle = $(posts[i]).find(ttag).text();
