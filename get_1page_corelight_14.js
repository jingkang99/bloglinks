...
var urlroot = 'https://corelight.com/blog';
var prdroot = '';
var opnroot = '';
var sourceb = '';    // category - cti prd opn

const TITLEST = "";
const REGULAR = ".post-item.no-img";
const FEATURE = "MMM";
const PAGESTY = '';

var IDXTITL = ".post-description h3";
var IDXAUTH = ".author-text";

var IDXDATE = ".entry-time"; // blog sect -> data
var BDYDATE = ".entry-time";

var BDYBLOG = ".blog-post";
var DBYAUTH = '.entry-author-name';
var BDYTAGS = ".MMM";
var BDYTITL = ".post-entry-title";
...
`;
    ...
    for(let i=0; i < gg.length; i++ ){       
        ...
        bodym = bodym.replaceAll(sss, '../data/' + uniq + '/' + imagename);

        $(gg[i]).attr("src", '../data/' + uniq + '/' + imagename);
        $(gg[i]).attr("style", "width: 90%");
