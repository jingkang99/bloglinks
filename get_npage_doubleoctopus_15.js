...
var urlroot = 'https://doubleoctopus.com/blog';
var prdroot = '';
var opnroot = '';
var sourceb = '';   // category - cti prd opn

const UNIQDAT = false;  // images are same file
const TITLEST = "- Secret double octopus";
const REGULAR = ".article-primary";
const FEATURE = "MMM";
const PAGESTY = '';

var IDXTITL = ".article-primary__title";
var IDXAUTH = ".MMM";

var IDXDATE = ".article-primary__date"; // blog sect -> data
var BDYDATE = ".article__date";

var BDYBLOG = ".article__content";
var DBYAUTH = '.MMM';
var BDYTAGS = ".MMM";
var BDYTITL = ".article__title.mb-0";
var WIDTHIM = "40%";
...
function parse_blog_url($, section){
    ...
    for (let i = 0; i < posts.length; i++) {
        ...
        //if(i==1) { console.log(item_json); process.exit(1); }
...
switch (arg[0]) {
    case '--save-urls':
        ...
        get_all_blog_url2array(urlroot, false, 22);
        break;
    case '--check-new':
