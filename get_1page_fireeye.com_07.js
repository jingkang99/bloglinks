...
var urlroot = 'https://www.fireeye.com/blog/threat-research.html';
var prdroot = 'https://www.fireeye.com/blog/products-and-services.html';
var opnroot = 'https://www.fireeye.com/blog/executive-perspective.html';
var sourceb = 'cti';    // category - cti prd opn

const TITLEST = "- FireEye Inc";
const REGULAR = ".c11v9";
const FEATURE = ".MMM";
...
switch (arg[0]) {
    case '--save-urls':
        ...
        get_all_blog_url2array(urlroot, true, 30);
        break;
    case '--check-new':
