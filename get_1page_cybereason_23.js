...
var urlroot = 'https://www.cybereason.com/blog/category/all';
var prdroot = '';
var opnroot = '';
...
const TITLEST = "";
const REGULAR = ".blog-listing__single-post";
const FEATURE = ".MMM";
const PAGESTY = ''; // page style

var IDXTITL = ".post-name .underline";
var IDXAUTH = ".MMM";
var IDXLINK = "a";

var IDXDATE = ".date-and-duration .publish-date";
var BDYDATE = "MMM";

var BDYBLOG = ".hs_cos_wrapper_type_rich_text";
var DBYAUTH = '.MMM';
var BDYTAGS = ".post-tags a";
var BDYTITL = ".column.is-8-fullhd h1";
