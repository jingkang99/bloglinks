...
var urlroot = 'https://www.nozominetworks.com/blog';
var prdroot = '';
var opnroot = '';
...
const TITLEST = "";
const REGULAR = ".resource-page-item-grid-block";
const FEATURE = ".MMM";
const PAGESTY = ''; // page style

var IDXTITL = ".resource-page-resource-block-item-header";
var IDXAUTH = ".MMM";
var IDXLINK = "a";

var IDXDATE = ".MMM";
var BDYDATE = ".post-author-date-wrapper .post-author-text-byline-date";

var BDYBLOG = ".post-body-rich-text-block";
var DBYAUTH = '.post-author-date-wrapper .post-author-text-byline-author';
var BDYTITL = ".post-title";
var DATAUTH = ".post-author-date-wrapper";
var BDYTAGS = ".MMMM";
...
async function find_blog_links(purl){
    ...
    $(".resources-page-filter-left-column-wrapper").remove();
...
async function save_blog_content(url, file){   
	...
	let dateauth = $(DATAUTH).html();
	//console.log( dateauth ); process.exit(1);
