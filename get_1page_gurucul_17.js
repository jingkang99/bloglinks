...
var urlroot = 'https://gurucul.com/blogs';
var prdroot = '';
var opnroot = '';
var sourceb = '';   // category - cti prd opn

const UNIQDAT = false;  // create image folder for each blog or not
const TITLEST = "- Secret double octopus";
const REGULAR = ".post-content-wrapper";
const FEATURE = "MMM";
const PAGESTY = '';     // page style

var IDXTITL = ".entry-title.title-h4 .light";
var IDXAUTH = ".post-meta-author";

var IDXDATE = ".entry-content.post-content";
var BDYDATE = ".post-meta-date";

var BDYBLOG = ".entry-content.post-content";
var DBYAUTH = '.MMM';
var BDYTAGS = ".post-tags-list a";
var BDYTITL = ".page-title-title";
var IMGSTYL = "";
