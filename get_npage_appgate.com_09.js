...
var urlroot = 'https://www.appgate.com/blog';
var prdroot = '';
var opnroot = '';
var sourceb = '';    // category - cti prd opn

const TITLEST = "Appgate |";
const REGULAR = ".col-span-12";
const FEATURE = "MMM";
const PAGESTY = 'p';

var IDXTITL = ".type.h5.pb-4";
var IDXDATE = ".timestamp";

var BDYBLOG = ".content.contains-list";
var BDYDATE = "MMM";
var BDYTAGS = ".btn.grey.self-center";
var BDYTITL = ".content h1";
