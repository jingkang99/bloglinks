...
var urlroot = 'https://www.securecircle.com/blog';
var prdroot = '';
var opnroot = '';
var sourceb = '';   // category - cti prd opn

const UNIQDAT = false;  // create image folder for each blog or not
const TITLEST = "- SecureCircle";
const REGULAR = ".resources__item.w-dyn-item";
const FEATURE = ".MMM";
const PAGESTY = ''; // page style

var IDXTITL = ".resource__link.w-inline-block h3";
var IDXAUTH = ".MMM";
var IDXLINK = "a";

var IDXDATE = ".resource__date:last";
var BDYDATE = "MMM";

var BDYBLOG = ".w-richtext";
var DBYAUTH = '.MMM';
var BDYTAGS = ".MMM";
var BDYTITL = "h1";
...
async function save_blog_content(url, file){   
    ...
    if(urlroot.match('appgate') ||
       ...
       urlroot.match('unit42')  ||
       urlroot.match('securecircle')
       )
