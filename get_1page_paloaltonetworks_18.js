...
var urlroot = 'https://www.paloaltonetworks.com/blog/';
var prdroot = '';
var opnroot = '';
...
const TITLEST = "MMM";
const REGULAR = ".feed-card.h-100";
const FEATURE = ".card-featured-inner.h-100";
const PAGESTY = '';     // page style

var IDXTITL = ".feed-card-content h3";
var IDXAUTH = ".MMM";
var IDXLINK = "h3 a";

var IDXDATE = ".author-name time";
var BDYDATE = "MMM";

var BDYBLOG = ".article-container";
var DBYAUTH = '.MMM';
var BDYTAGS = ".tags-item a";
var BDYTITL = ".blog-title";
var IMGSTYL = "";
...
async function save_blog_content(url, file){   
    ...
    if(bodym == null) return [null, null, null];   // diff format blog
    ...
    for(var i = 0, j=1; i < blogs.length; i++) {
        ...
        try {
            ...
            if(bfilelist.match(f) ){    // blog file exists
                ...
                let bdate;
                if(obj.blink.match('/(unit42-|unit-42-|threat-brief-)')) continue; // skip unit42 blog
    ...
    for(var i = 0;  i < blogs.length; i++) {
        ...
        if(strsearch !=  null){
            if(obj.title.match(regex) ) 
                console.log('find: %i %s', i, obj.blink.green), j++;
        }else{
